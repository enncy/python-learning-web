(function () {
  ...
  util.extend(Spring.prototype, {
    ...
    getDisplacementDistanceForState: function getDisplacementDistanceForState(
      state
    ) {
    ...
    // `endValue`.
    setRestDisplacementThreshold: function setRestDisplacementThreshold(
    ...
    notifyPositionUpdated: function notifyPositionUpdated(
      notifyActivate,
      notifyAtRest
    ) {
      for (var i = 0, len = this.listeners.length; i < len; i++) {
  ...
  var BouncyConversion = (rebound.BouncyConversion = function (
    bounciness,
    speed
  ) {
  ...
  util.extend(BouncyConversion.prototype, {
    ...
    quadraticOutInterpolation: function quadraticOutInterpolation(
      t,
      start,
      end
    ) {
  ...
  util.extend(SpringConfig, {
    ...
    // Rebound.
    fromOrigamiTensionAndFriction: function fromOrigamiTensionAndFriction(
      tension,
      friction
    ) {
    ...
    coastingConfigWithOrigamiFriction:
      function coastingConfigWithOrigamiFriction(friction) {
        return new SpringConfig(
          0,
          OrigamiValueConverter.frictionFromOrigamiValue(friction)
        );
  ...
  var MathUtil = (rebound.MathUtil = {
    ...
    mapValueInRange: function mapValueInRange(
      value,
      fromLow,
      fromHigh,
      toLow,
    ...
    interpolateColor: function interpolateColor(
      val,
      startColor,
      endColor,
      fromLow,
...
var Polygon = (function () {
  function Polygon() {
    var radius =
      arguments.length <= 0 || arguments[0] === undefined ? 100 : arguments[0];
    var sides =
      arguments.length <= 1 || arguments[1] === undefined ? 3 : arguments[1];
    var depth =
  ...
  _createClass(Spinner, [
      ...
      value: function _addSpringListener() {
        ...
        this._spring.addListener({
          onSpringUpdate: function onSpringUpdate(spring) {
            ...
            val = rebound.MathUtil.mapValueInRange(
              val,
              fromLow,
              fromHigh,
              toLow,
    ...
    },
    {
      ...
      value: function _switchSpringRange() {
        ...
        this._springRangeLow =
          this._springRangeLow === threshold ? 0 : threshold;
        this._springRangeHigh =
          this._springRangeHigh === threshold ? 1 : threshold;
      },
...
var demo = {
  ...
  initRebound: function initRebound() {
    ...
    demo.spring = springSystem.createSpring(
      settings.tension,
      settings.friction
    );
  },
